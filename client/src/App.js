...
import { VaccinationCenterListing } from './containers/VaccinationCenter/ListVaccinationCenters'
      ...
      <LocalizationProvider dateAdapter={AdapterDateFns}>
        <BrowserRouter>
            ...
            <Switch>
              ...
              <Route path="/vaccination_centers" exact component={VaccinationCenterListing} />
